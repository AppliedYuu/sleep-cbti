...
.welcome-hint { font-size: var(--fs-sm) !important; color: var(--text-muted) !important; margin: 0.8rem 0 0.5rem; }
...
.btn-clear:hover { color: var(--text-strong); border-color: var(--border-glow); }
</style>
